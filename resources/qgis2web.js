...
map.getView().fit([-8611949.019429, -1290657.484335, -8203477.242044, -975399.934731], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA DEL DEPARTAMENTO DE PASCO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (92 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue creado por Vania Molina para el curso Cartografía y SIG<br />UPN-2025<br />Vania Molina<br />';
            }
